...
export default function Room({ name, type, beds }) {
    return (
        <Box
            sx={{
                padding: "75px 20px",
        ...
        >
            ...
            >
                ...
                <Typography variant="body2">
                    ...
                    Laborum sunt qui dolor sit ad nostrud sit sit adipisicing fugiat veniam proident aliqua. Culpa quis
                    officia aute incididunt sunt culpa dolore fugiat sint culpa aliqua. Aute exercitation deserunt
                    labore cupidatat qui. Fugiat eiusmod dolor elit labore fugiat id proident sunt cupidatat occaecat
                    duis duis. Consectetur ullamco duis nulla dolor.
                </Typography>
            </Box>
            <Box sx={{ width: "50%" }}>
