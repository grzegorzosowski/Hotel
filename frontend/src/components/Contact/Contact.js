        ...
        >
            <Box
                ...
                <form>
                    ...
                    <TextField fullWidth multiline rows={5} label='Message' size='small'> </TextField>
                    <CommonButton type='submit' variant='contained' color='primary' size='large' sx={{px: 5, mt: 3}}>Send</CommonButton>
                </form>
            </Box>
        </Box>
        </>
